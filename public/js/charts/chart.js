...
// See Chart.core.datasetController.dataElementType
  ...
  module.exports = function(Chart) {
    ...
    // Scatter charts use line modules
  ...
  module.exports = function(Chart) {
    ...
    helpers.extend(Chart.Controller.prototype, /** @lends Chart.Controller */ {
      ...
      initialize: function initialize() {
        ...
        // Make sure modules are built first so that each dataset is bound to an axis before the scales
        // are built
      ...
      update: function update(animationDuration, lazy) {
        ...
        // Make sure dataset modules are updated and new modules are reset
        var newControllers = me.buildOrUpdateControllers();

        // Make sure all dataset modules have correct meta data counts
        helpers.each(me.data.datasets, function(dataset, datasetIndex) {
        ...
        // Can only reset the new modules after the scales have been updated
  ...
  module.exports = function(Chart) {
    ...
    // Base class for all dataset modules (line, bar, etc)
